...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">{{ Auth::guard('cashier')->user()->name }}</span>
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{ route('cashier.changePassword') }}">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="{{ route('cashier.logout') }}">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link nav-link-icon collapsed" href="{{ route('cashier.room.index') }}">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('cashier.bookingHistory') }}">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="dropdown-menu" aria-labelledby="accounts-dropdown">
          <li>
            <a class="dropdown-item" href="{{ route('cashier.guestList') }}">
            <i class="fa-solid fa-users"></i><span>&nbsp Guest</span>
            </a>
          </li>
          <li>
            <a class="dropdown-item" href="{{ route('cashier.frontdeskList') }}">
            <i class="fa-sharp fa-solid fa-user-tie"></i><span>&nbsp Frontdesk</span>
            </a>
          </li>
          <li>
            <a class="dropdown-item" href="{{ route('cashier.cashierList') }}">
            <i class="fa-solid fa-users"></i><span>&nbsp Cashier</span>
            </a>
          </li>
          <li>
            <a class="dropdown-item" href="{{ route('cashier.stockcontrollerList') }}">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="dropdown-menu" aria-labelledby="accounts-dropdown">
          <li>
            <a class="dropdown-item" href="{{ route('cashier.menuListDashboard') }}">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('cashier.reports') }}">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      ...
                      <a href="{{ route('cashier.guestList') }}">View</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      ...
                      <a href="{{ route('cashier.frontdeskList') }}">View</a>
                    </div>
                  </div>
              </div>
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>{{ $totalCashier }}</h6>
                      <a href="{{ route('cashier.cashierList') }}">View</a>
                    </div>
                  </div>
              </div>
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>{{ $totalStockController }}</h6>
                      <a href="{{ route('cashier.stockcontrollerList') }}">View</a>
                    </div>
                  </div>
              </div>
              ...
              <div class="card info-card room-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>{{ $totalRoom }}</h6>
                      <a href="{{ route('cashier.roomList') }}">View</a>
                    </div>
                  </div>
                </div>
