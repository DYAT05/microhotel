        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <div class="d-flex justify-content-between mb-3">
                <div class="ml-auto">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addNewRoomType">
                    <i class="fa-solid fa-plus"></i>&nbsp Add New</button>
                </div>
            </div>
            
<!-- Modal -->
<div class="modal fade" id="addNewRoomType">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" style="color: #55afab">Add New Room Type</h4>
  ...
  <table class="table table-condensed table-sm table-bordered">   
      ...
      @foreach ($roomtypes as $roomtype)
          <tr>     
              <td style="text-align:center">{{ $roomtype->name }}</td>
              <td class="text-center">
              <!--View Button-->	
                <!-- Button trigger deactivate modal -->
                <button type="button"  class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteroomtype{{ $roomtype->id }}">
...
<div class="modal fade" id="deleteroomtype{{ $roomtype->id }}" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{ route('admin.deleteroomtype', $roomtype->id) }}">
                @csrf
                @method('PATCH')
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"  style="color: #55afab;">Delete Room Type</h5>
