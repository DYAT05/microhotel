...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
      <a class="nav-link " href="{{ route('admin.manageDashboard') }}">
        <i class="bi bi-grid"></i>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Manage Dashboard Content</h1><br>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
          <li class="breadcrumb-item active">Dashboard Content</li><br>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <form action="{{ route('admin.dashboard.update',  $content->id ?? '') }}" method="POST" id="editDashboardForm" enctype="multipart/form-data">
              @csrf
              @method('POST')
              ...
              <div class="form-group font-semibold">
                  <label>Image 1</label>
                  <p>(png/jpg/jpeg)</p>
                  <input type="file" name="image1" class="form-control" id="image1" accept="image/png, image/gif, image/jpeg">
                  <img src="{{ asset('uploads/dashboard/' . ($content->image1 ?? '')) }}" alt="Image 1" width="70px" height="70px">
                  <x-input-error :messages="$errors->get('image1')" />
              </div>
              <div class="form-group font-semibold">
                  <label>Image 2</label>
                  <p>(png/jpg/jpeg)</p>
                  <input type="file" name="image2" class="form-control" id="image2" accept="image/png, image/gif, image/jpeg">
                  <img src="{{ asset('uploads/dashboard/' . ($content->image2 ?? '')) }}" alt="Image 2" width="70px" height="70px">
                  <x-input-error :messages="$errors->get('image2')" />
              </div>
              <div class="form-group font-semibold">
                  <label>Image 3</label>
                  <p>(png/jpg/jpeg)</p>
                  <input type="file" name="image3" class="form-control" id="image3" accept="image/png, image/gif, image/jpeg">
                  <img src="{{ asset('uploads/dashboard/' . ($content->image3 ?? '')) }}" alt="Image 3" width="70px" height="70px">
                  <x-input-error :messages="$errors->get('image3')" />
              </div>
              <div class="form-group font-semibold">
                  <label>Image 4</label>
                  <p>(png/jpg/jpeg)</p>
                  <input type="file" name="image4" class="form-control" id="image4" accept="image/png, image/gif, image/jpeg">
                  <img src="{{ asset('uploads/dashboard/' . ($content->image4 ?? '')) }}" alt="Image 4" width="70px" height="70px">
                  <x-input-error :messages="$errors->get('image4')" />
              </div>

              <div class="form-group font-semibold">
                  <label>Description</label>
                  <textarea class="form-control" type="text" name="contents" id="contents" placeholder="Enter Content">{{ ($content->contents ?? '') }}</textarea>
                  <x-input-error :messages="$errors->get('contents')" />
              </div>
