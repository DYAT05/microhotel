...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
      <a class="nav-link " href="{{ route('admin.guestFeedback') }}">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Guest Feedbacks</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                ...
                <tbody>   
                    @foreach ($feedbacks as $feedback)
                        <tr>     
                            ...
                            <td style="text-align:center">{{ $feedback->email }}</td>
                            <td style="text-align:center">{{ $feedback->company }}</td>
                            <td style="text-align:center">{{ $feedback->mobilenumber }}</td>
