    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Restaurant Report</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <form id="filter-form" action="{{ route('admin.restaurantreport.preview') }}" method="get" class="mb-[50px]">
            ...
            <table id="datatable" class="table table-condensed table-sm table-bordered">   
                <thead class="bg-[#51bdb8] text-white">   
                    <tr class="text-center ">   
                        <th scope="col" class="text-center px-1 py-3">Date</th>
                        <th scope="col" class="text-center px-1 py-3">Cashier</th>
                        <th scope="col" class="text-center px-1 py-3">Transaction Count</th>
                        <th scope="col" class="text-center px-1 py-3">Total Sales</th>
                    </tr>   
                </thead>   
                </tbody> 
                ...
                <tr class="text-center py-5" >
                    ...
                    <td scope="col">{{ number_format($report->counttransaction) }}</td> 
                    <td scope="col">{{ number_format($report->grandtotalamount, 2) }}</td>
                </tr>
                @endforeach  
            </table>
