                        ...
                        <div class="row justify-content-center">
                          <div class="col-10">
                            <div class="form-group">
                              ...
                              <input class="form-control" style="position:relative; left: -20px; width: 450px;" type="text" name="first_name" id="first_name" value="{{ $data->first_name }}" required readonly>
                            </div>
                            <div class="form-group">
                              <label for="last_name" class="font-weight-bold text-gray-700" style="position:relative; left: -20px;">Last Name:</label>
                              <input class="form-control" style="position:relative; left: -20px; width: 450px;" type="text" name="last_name" id="last_name" value="{{ $data->last_name }}" required readonly>
                            </div>
                            <div class="form-group">
